    ...
    public class PublicModule : ModuleBase<SocketCommandContext>
    {
        ...
        public async Task OnCommand()
        {
            try
            {
                ...
                await ReplyAsync($"Quantidade de jogadores online: **{Global.Players.Count()}**");
            }
            catch (Exception ex)
            {
                TratarException(ex);
        ...
        public async Task AppCommand()
        {
            try
            {
                ...
                x.AddField("Sexo", Functions.GetEnumDisplay(app.Sex), true);
        ...
        public async Task VipCommand(string usuario, byte nivelVip, int meses)
        {
            try
            {
                ...
                if (target != null)
                {
                    ...
                    target.SendMessage(Models.MessageType.Success, $"{userStaff.Name} alterou seu nível VIP para {Functions.GetEnumDisplay(vip)} expirando em {user.VIPValidDate}.");
                }
                else
                {
                    context.Users.Update(user);
                ...
                await ReplyAsync($"Você alterou o nível VIP de {user.Name} para {Functions.GetEnumDisplay(vip)} expirando em {user.VIPValidDate}.");
            }
            catch (Exception ex)
            {
                TratarException(ex);
