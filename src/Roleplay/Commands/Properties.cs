    ...
    public class Properties
    {
        ...
        public static void CMD_pvender(MyPlayer player, string idNome, int valor)
        {
            ...
            var convite = new Invite()
            {
                ...
                Value = new string[] { prop.Id.ToString(), valor.ToString() },
            };
        ...
        public static async Task CMD_arrombar(MyPlayer player)
        {
            ...
            await Task.Delay(200000, player.CancellationTokenSourceAcao.Token).ContinueWith(t =>
            {
                ...
                Task.Run(async () =>
                {
                    ...
                    await player.GravarLog(LogType.Arrombar, prop.Id.ToString(), null);
        ...
        public static async Task CMD_roubarpropriedade(MyPlayer player)
        {
            ...
            if (Global.Players.Count(x => x.Faction?.Type == FactionType.Police && x.OnDuty) < Global.Parameter.PoliceOfficersPropertyRobbery)
            {
            ...
            await Task.Delay(waitSeconds * 1000, player.CancellationTokenSourceAcao.Token).ContinueWith(t =>
            {
                ...
                Task.Run(async () =>
                {
                    ...
                    await player.GravarLog(LogType.RoubarPropriedade, $"{prop.Id} {value}", null);
                    player.CancellationTokenSourceAcao = null;
                });
            });
        }
        ...
        public static async Task CMD_roubararmazenamento(MyPlayer player)
        {
            ...
            await Task.Delay(waitSeconds * 1000, player.CancellationTokenSourceAcao.Token).ContinueWith(t =>
            {
                ...
                Task.Run(async () =>
                {
                    ...
                    await player.GravarLog(LogType.RoubarArmazenamento, prop.Id.ToString(), null);
                    player.CancellationTokenSourceAcao = null;
                    prop.ShowInventory(player, false);
                });
            });
        ...
        public static void CMD_mobilias(MyPlayer player)
        {
            ...
            player.Emit("PropertyFurnitures", prop.Id, prop.GetFurnituresHTML(player));
        }
    }
}